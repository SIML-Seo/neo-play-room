      ...
      <form onSubmit={handleSubmit} className="p-4 border-t border-gold-dark/30 bg-wood-dark/30">
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 px-3 py-2 border-2 border-gold-dark/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold-frame focus:border-transparent text-sm text-gallery-floor bg-gallery-ivory text-white"
            maxLength={200}
            disabled={isSending}
          />
          <button
