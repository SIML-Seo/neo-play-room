          ...
          <div className="bg-wood-dark rounded-lg p-8 md:p-12 space-y-8">
            ...
            <div className="max-w-md mx-auto space-y-4">
              <button
                ...
                className="w-full px-8 py-6 bg-gold-frame text-gallery-floor font-playfair font-bold text-2xl
              ...
              >
                {isSigningIn ? (
                  <>
                    <div className="w-8 h-8 border-3 border-gallery-floor border-t-transparent rounded-full animate-spin" />
                    <span>갤러리 입장 중...</span>
                  </>
                ) : (
                  <>
