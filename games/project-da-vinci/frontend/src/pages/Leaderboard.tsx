...
export default function Leaderboard() {
  ...
  // 회차별 데이터 배열로 변환 (최신순)
  const sessions = Array.from(groupedLogs.entries()).sort(([dateA], [dateB]) =>
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4">
        ...
        {sessions.map(([dateKey, sessionLogs], sessionIndex) => {
          ...
          const failedLogs = sessionLogs.filter((log) => log.result !== 'success')
            ...
            <div key={dateKey} className="mb-12">
              ...
              <div className="mb-4">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  총 {sessionLogs.length}개 게임 (성공: {rankedLogs.length}개, 실패:{' '}
                  {failedLogs.length}개)
                </p>
              </div>
                            ...
                            <div className="space-y-4">
                              {log.aiGuessList.map((guess, idx) => {
                                ...
                                if (idx === 0) {
                                  ...
                                  console.log(
                                    '[Leaderboard] aiGuessList 길이:',
                                    log.aiGuessList.length
                                  )
                                }
              ...
              {failedLogs.length > 0 && (
                <div className="mt-8 space-y-4">
                  <h3 className="text-xl font-bold text-gray-700 mb-4">실패한 게임</h3>
                  {failedLogs.map((log) => (
                    <div
                      key={log.logId}
                      className="bg-white rounded-xl shadow-sm border border-red-200 p-6 hover:shadow-md transition-shadow opacity-80"
                    >
                      <div className="flex items-start gap-6">
                        {/* 실패 아이콘 */}
                        <div className="flex-shrink-0">
                          <div className="w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold bg-red-100 text-red-700">
                            ❌
                          </div>
                        </div>
                        ...
                        <div className="flex-1">
                          ...
                          {/* AI 추론 히스토리 */}
                          {log.aiGuessList && log.aiGuessList.length > 0 && (
                            <div className="mt-4">
                              <h4 className="text-sm font-semibold text-gray-700 mb-3">
                                AI 추론 히스토리 (턴별 그림 + 판정)
                              </h4>
              ...
              <div className="px-6 py-6 space-y-6">
                ...
                <div>
                    ...
                    <table className="w-full text-sm border-collapse">
                      ...
                      <tbody className="divide-y divide-gray-200">
                        <tr className="hover:bg-gray-50">
                          ...
                          <td className="px-3 py-2 text-center text-gray-700">3턴</td>
                          <td className="px-3 py-2 text-center text-gray-700">120초</td>
                        ...
                        <tr className="hover:bg-gray-50">
                          ...
                          <td className="px-3 py-2 text-center text-gray-700">4턴</td>
                          <td className="px-3 py-2 text-center text-gray-700">100초</td>
                          <td className="px-3 py-2 text-right font-bold text-purple-600">
                            3,177점
                          </td>
                        </tr>
                        <tr className="hover:bg-gray-50">
                          ...
                          <td className="px-3 py-2 text-center text-gray-700">5턴</td>
                          <td className="px-3 py-2 text-center text-gray-700">80초</td>
                          <td className="px-3 py-2 text-right font-bold text-purple-600">
                            3,205점
                          </td>
                        </tr>
                        <tr className="bg-yellow-50 border-t-2 border-yellow-300">
                          ...
                          <td className="px-3 py-2 text-center font-bold text-gray-700">3턴</td>
                          <td className="px-3 py-2 text-center font-bold text-gray-700">90초</td>
                  ...
                  <div className="mt-3 text-sm text-gray-600 bg-yellow-50 border border-yellow-200 rounded p-3">
                    💡 <strong>핵심:</strong> Hard 난이도로 3턴에 성공하면, Easy 난이도 3턴보다 훨씬
                    낮은 점수(높은 순위)를 받습니다!
                  </div>
                </div>
