            ...
            <div key={dateKey} className="mb-12">
              ...
              <div className="mb-4">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  총 {sessionLogs.length}개 게임 (성공: {rankedLogs.length}개, 실패: {failedLogs.length}개)
                </p>
              </div>
                                  ...
                                  >
                                    <div className="flex items-start gap-4">
                                      ...
                                      <div className="flex-1">
                                        ...
                                        <div className="text-sm">
                                          <span className="text-gray-600">AI 추측: </span>
                                          <span className="font-semibold text-gray-900">{guess.guess}</span>
                                        </div>
                                        <div className="text-xs text-gray-500 mt-1">
                                          {new Date(guess.timestamp).toLocaleString('ko-KR')}
                                        </div>
                    ...
                    <table className="w-full text-sm border-collapse">
                      <thead>
                        <tr className="bg-gray-100 border-b-2 border-gray-300">
                          <th className="px-3 py-2 text-left font-semibold text-gray-700">난이도</th>
                          <th className="px-3 py-2 text-center font-semibold text-gray-700">턴 수</th>
                          <th className="px-3 py-2 text-center font-semibold text-gray-700">시간</th>
