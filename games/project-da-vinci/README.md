...
- **소요 턴**: 4턴
- **소요 시간**: 2분 10초
- **순위**: 전체 10개 팀 중 **3위** (동일 턴 수 중 시간이 빨랐음)
...
| 팀 | 단어 | 소요 턴 | 소요 시간 | 전략 |
|----|------|:-------:|:---------:|------|
| **A팀** 🥇 | "피노키오" | 3턴 | 1분 50초 | 코 길게 그려서 바로 인식 |
| **B팀** 🥈 | "신데렐라" | 3턴 | 2분 05초 | 유리구두+호박마차 조합 |
| **우리팀** 🥉 | "백설공주" | 4턴 | 2분 10초 | 사과→공주→왕관→난쟁이 순차적 |
| C팀 | "인어공주" | 5턴 | 3분 20초 | 물고기 꼬리 표현에 시간 소요 |
| D팀 | "라푼젤" | 6턴 | 4분 15초 | 긴 머리만으로는 AI가 추론 실패 |
